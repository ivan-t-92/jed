...
public class Main {
    public static void main(String[] args) {
        ...
        int id = 0;
        try {
            c.add(new PetDataAdapter(id++, "Rex", eric, 40));
            c.add(new PetDataAdapter(id++, "Rex", eric, 50));
            c.add(new PetDataAdapter(id++, "Hunter", eric, 20));
            c.add(new PetDataAdapter(id++, "Jasper", sarah, 5));
            c.add(new PetDataAdapter(id++, "Jack", sarah, 10));
            c.add(new PetDataAdapter(id++, "Jack", john, 20));
        ...
        PetData newData = new PetDataAdapter(5, "Lucy", john, 10);
        ...
        try {
            c.add(new PetDataAdapter(0, "Rex", eric, 40));
        } catch (AlreadyExistsException ex) {
            ex.printStackTrace();
        }
        System.out.println();
