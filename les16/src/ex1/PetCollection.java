...
public class PetCollection {
    ...
    private final HashedUniqueIndex<Integer, PetData> idIndex = new HashedUniqueIndex<>(PetData::id);
    private final HashedNonUniqueIndex<String, PetData> nameIndex = new HashedNonUniqueIndex<>(PetData::name);
